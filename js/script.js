...
class ParallaxManager {
    ...
    update() {
        ...
        /*
         * 💡 What: Use traditional for loop instead of Array.prototype.forEach.
         * 🎯 Why: Eliminates function call overhead for every iteration in a high-frequency (60fps) update loop.
         * 📊 Impact: Measurably faster execution time per frame compared to higher-order functions.
         */
